...
xlim([-max_ell max_ell])
ylim([-max_ell-15000 max_ell]-15000)
zlim([-max_ell max_ell])
...
xlim([-max_ell max_ell])
ylim([-max_ell max_ell])
zlim([-max_ell max_ell])
legend('Interpreted data','Raw data')
...
hold on
ellPlot(v4,max_ell);
plot3(data4(1,:),data4(2,:),data4(3,:),'bo')
xlim([-max_ell max_ell])
ylim([-max_ell max_ell])
zlim([-max_ell max_ell])
